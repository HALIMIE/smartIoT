...
int main(int argc, char *argv[]) {
  ...
  CLIENT_INFO client_info[MAX_CLNT] = {
      ...
      {0, -1, "", "25", "PASSWD"},      {0, -1, "", "LJH_SQL", "PASSWD"},
      {0, -1, "", "LJH_BT", "PASSWD"},  {0, -1, "", "LJH_STM32", "PASSWD"},
      {0, -1, "", "LJH_LIN", "PASSWD"}, {0, -1, "", "LJH_AND", "PASSWD"},
      {0, -1, "", "LJH_ARD", "PASSWD"}, {0, -1, "", "HM_CON", "PASSWD"}};
...
void send_msg(MSG_INFO *msg_info, CLIENT_INFO *first_client_info) {
  ...
  if (!strcmp(msg_info->from, "LJH_ARD")) {
    for (i = 0; i < MAX_CLNT; i++) {
